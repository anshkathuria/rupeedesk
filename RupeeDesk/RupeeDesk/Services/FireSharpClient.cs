...
using Utilities;
using RupeeDesk.Constants;
using RupeeDesk.Interfaces;

namespace RupeeDesk.Services
{
    public sealed class FireSharpClient
    {
        ...
        public async void OnAddAll<T>(string path, ObservableDictionary<string, T> dict) where T : IBaseModel, new()
        {
